...
const galeriaTranslations: GaleriaTranslations = {
  es: {
    ...
    'footer.tuesday': 'Lunes - Miércoles',
    'footer.wednesday': 'Lunes - Miércoles',
    'footer.thursday': 'Lunes - Miércoles',
  ...
  en: {
    ...
    'footer.tuesday': 'Monday - Wednesday',
    'footer.wednesday': 'Monday - Wednesday',
    'footer.thursday': 'Monday - Wednesday',
  ...
  ru: {
    ...
    'footer.tuesday': 'Понедельник - Среда',
    'footer.wednesday': 'Понедельник - Среда',
    'footer.thursday': 'Понедельник - Среда',
